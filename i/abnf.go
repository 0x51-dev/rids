...
var (
	IRI           = op.Capture{Name: "IRI", Value: op.And{u.Scheme, ':', IhierPart, op.Optional{Value: op.And{'?', Iquery}}, op.Optional{Value: op.And{'#', Ifragment}}}}
	...
	AbsoluteIRI   = op.Capture{Name: "AbsoluteIRI", Value: op.And{u.Scheme, ':', IhierPart, op.Optional{Value: op.And{'?', Iquery}}}}
	...
	Iauthority    = op.Capture{Name: "Iauthority", Value: op.And{op.Optional{Value: op.And{Iuserinfo, '@'}}, Ihost, op.Optional{Value: op.And{':', u.Port}}}}
	Iuserinfo     = op.Capture{Name: "Iuserinfo", Value: op.ZeroOrMore{Value: op.Or{Iunreserved, u.PctEncoded, u.SubDelims, ':'}}}
	Ihost         = op.Capture{Name: "Ihost", Value: op.Or{u.IPLiteral, u.IPv4address, IregName}}
	IregName      = op.Capture{Name: "IregName", Value: op.ZeroOrMore{Value: op.Or{Iunreserved, u.PctEncoded, u.SubDelims}}}
	...
	IsegmentNzNc  = op.Capture{Name: "IsegmentNzNc", Value: op.OneOrMore{Value: op.Or{Iunreserved, u.PctEncoded, u.SubDelims, '@'}}}
	Ipchar        = op.Capture{Name: "Ipchar", Value: op.Or{Iunreserved, u.PctEncoded, u.SubDelims, ':', '@'}}
